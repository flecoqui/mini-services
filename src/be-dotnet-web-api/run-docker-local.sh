...
export IMAGE_NAME="be-dotnet-web-api"
...
#fi
cmd="docker run -d -e ARG_PORT_HTTP=${PORT_HTTP}   -e APP_VERSION=${IMAGE_TAG} -p ${PORT_HTTP}:${PORT_HTTP}/tcp     ${IMAGE_NAME}:${ALTERNATIVE_TAG}  "
echo "${cmd}"
